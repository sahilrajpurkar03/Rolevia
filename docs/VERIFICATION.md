...
- Eleven unit tests: profile-driven matching, international regions, geographic restrictions on remote roles, employment classification, keyword boundaries, grounded letter drafting, profile validation, invalid uploads, real generated PDF/DOCX extraction and CV section suggestions.
