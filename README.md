...
Production verification (14 September 2026, three robotics queries) returned 30 LinkedIn, 22-26 Indeed and 30 Xing listings before deduplication/ranking. Google returned zero (`empty_or_blocked`); StepStone timed out from Vercel despite returning 10 dated/typed listings locally. Those two hosted-source gaps remain unresolved; five working sources must not be claimed. No paid proxies, CAPTCHA bypass or paid API was introduced.
